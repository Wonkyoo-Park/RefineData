...
if __name__ == "__main__":
    ...
    parser.add_argument('--input_image_dir', '-i', default="/home/projects/data/capture_for_demo/cherry_eye_img/",
                        type=str, help='an input folder to original dataset')
    parser.add_argument('--input_json_dir', '-j', default="/home/projects/data/capture_for_demo/cherry_eye_labelme/",
                        type=str, help='an input folder including json files of segmentation')
    parser.add_argument('--output_dir', '-o', default="/home/projects/data/validation/",type=str, help='an input folder for refined data to be saved')
