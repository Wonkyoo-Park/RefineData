...
if __name__ == "__main__":
    ...
    parser.add_argument("--path2base", default='/home/projects/data/train/', type=str)
    parser.add_argument("--path2base_val", default='/home/projects/data/validation/', type=str)
    parser.add_argument("--path2base_only_img", default='/home/projects/data/capture_for_demo/', type=str)
